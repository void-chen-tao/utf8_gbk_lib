///*  This file defines all the converters  ——  当前文件定义了不同编码之间转换的函数和相关的宏  */
...
//* 
//*	usc4_t		用来表示宽字符类型
//*	state_t		用来定义转换器结构体当前的状态
//*	conv_t		转换器结构体指针
//*	iconv_t		为了保护数据而使用的void指针
//*/
...
//	*
//	*	成员：
//	*		*xxx_mbtowc		函数指针——这儿主要是指向utf-8编码转unicode编码的函数
//	*
//	*		参数：
//	*			conv		转换器结构体
//	*			pwc			宽字节存储地址
...
//	*
//	*	成员：
//	*		*xxx_wctomb		函数指针——这儿主要是指向unicode编码转gbk编码的函数
//	*
//	*		参数：
//	*			conv		转换器结构体
//	*			r			gbk存储缓冲区
...
//} Summary16;
//
///*  transcoding function error  */
//#define TRANSCODING_FUNCTION_CALLED_FAILURE		-3
///*==============================================================================
//*									utf8.h										*
//* ==============================================================================*/
//
...
//*/
//static int utf8_mbtowc(conv_t conv, ucs4_t* pwc, const unsigned char* s, size_t n)
//{
//	unsigned char c = s[0];
//
//	if (c < 0x80) {
...
//
//	/*
//	*	unicode不能为0011 0000 1111 1011和0010 0000 0001 0101
//	*/
...
//		{
//			if (ret != 2)
//				return TRANSCODING_FUNCTION_CALLED_FAILURE;
//			if (n < 2)
//				return RET_TOOSMALL;
//			r[0] = buf[0] + 0x80;
//			r[1] = buf[1] + 0x80;
...
//
///*
//*	分析wc字符串是否小于128，小于128则说明应该将其转换为ascii码，否则转换为gbk编码。
//*
//*   参数：
//*       conv        转化器结构体
//*       r           gbk缓冲区
...
//
//
//#define XXX_MBTOWC					(unsigned)1
//#define NO_ENOUGH_OUTPUT_BUFFER		(unsigned)2
//#define XXX_WCTOMB					(unsigned)3
//#define OTHER						(unsigned)4
//#define CONFILCT					(unsigned)5
///*========================================================
//*						loop_unicode.h					 *
//* =======================================================*/
...
//
//	/*  循环处理输入字符，知道输入字符剩余为0结束  */
//	while (inleft > 0)
//	{
//		//	定义一个unicode字符,用于utf-8 --> unicode --> gbk的中间变量
//		ucs4_t wc;
//		//	一个完整的utf-8字符所占用的字节byte空间计数
//		int incount;
//		//	一个完整的gbk字符所占用的字节byte空间计数
//		int outcount;
//
//
//		/*
//		*	调用utf-8转wide char函数。
//		* 
//		*	如果转换成功，将该utf-8字符串的unicode编码存储在wc中，并且返回该utf-8字符由多少个bytes组成。
//		*	如果转换失败，编码无效返回-1、长度与inleft不匹配返回-2。
//		*/
...
//		else
//		{
//			/*  转换函数调用成功，准备调用unicode转宽字节函数  */	
//			if (outleft == 0)
//			{
//				//	剩余空间不足
//				result = NO_ENOUGH_OUTPUT_BUFFER;
//				break;
//			}
//			else
//			{
